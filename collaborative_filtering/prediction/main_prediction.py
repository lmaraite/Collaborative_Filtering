...
print(predicition_cosine_similarity(750, 0, data))
print(predicition_cosine_similarity(1341, 0, data))
print(predicition_cosine_similarity(1357, 0, data))
print(predicition_cosine_similarity(1388, 0, data))
print(predicition_cosine_similarity(1661, 0, data))
